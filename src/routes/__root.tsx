  ...
  head: () => ({
    meta: [
      ...
      { title: "Bincá · Oficinas Afetivas" },
      {
        name: "description",
        content:
          "Oficinas sensoriais afetivas para crianças de 0 a 6 anos. Experiências 100% naturais que fortalecem o vínculo entre pais e filhos.",
      },
      ...
      { property: "og:title", content: "Bincá · Oficinas Afetivas" },
      {
        ...
        content:
          "Oficinas sensoriais afetivas para crianças de 0 a 6 anos.",
      },
